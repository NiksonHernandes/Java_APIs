package br.com.sevencomm.usuario.application.config.security.jwt;

import br.com.sevencomm.usuario.domain.models.User;
import br.com.sevencomm.usuario.domain.models.dtos.SsoDTO;
import br.com.sevencomm.usuario.domain.models.dtos.UserDTO;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        ssoDTO.setCurrent_user(UserDTO.toDTO(user));
